...
import com.test.reporting.reportingtool.repositories.AppRepository;
...
public class ApplicationController {
    ...
    public EntityModel<Application> findApplication(@PathVariable("name") final String name) {
        return appRepository.findByName(name)
            .map(app -> new EntityModel<>(app, linkTo(methodOn(ApplicationController.class).findApplication(app.getName())).withSelfRel(),
                linkTo(methodOn(ApplicationController.class).getApplications()).withRel("applications")))
            .orElseThrow(RuntimeException::new);
    }
